...
>>>>>>> d6cbcb259006fd412927311548e2567b28934a30
...
def rc_yaw(rc_value):
	rc_value = rc_filter(rc_value, 1100, 19000)
...
while v.channel_readback['5'] > 1400:
	screen.erase()
	if switch1 == True:
	...
	curses_print("Currently taking values from RC transmitter", 0, 0)
	while v.channel_readback['6'] < 1400:
		#v.mode = VehicleMode("AUTO")
=======
reset = True
