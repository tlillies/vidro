...
while True:
	...
	curses_print("Roll: " + str(vidro.current_rc_channels[0])
	curses_print("Pitch: " + str(vidro.current_rc_channels[1])
	curses_print("Throttle: " + str(vidro.current_rc_channels[2])
	curses_print("Yaw: " + str(vidro.current_rc_channels[3])
