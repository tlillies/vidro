...
def make_box(start_y, start_x, size_y, size_x):
	for i in range(start_y+1, start_y+size_y):
		screen.addstr(i, start_x, "|")
		screen.addstr(i, start_x+size_x, "|")
	for j in range(start_x+1, start_x+size_x):
		screen.addstr(start_y, j, "_")
		screen.addstr(start_y+size_y-1, j, "_")
...
try:
	...
	while True:
		...
		screen.addstr(1, 36, "--RECUV--")
		screen.addstr(2, 25, "***GCS with VICON streaming data***")
		screen.addstr(4,0,"       Vicon Data")
		screen.addstr(6,0,"  Time: " + str(s.getData()[0]))
		screen.addstr(7,0,"     X: "  + str(s.getData()[1]))
		screen.addstr(8,0,"     Y: "  + str(s.getData()[2]))
		screen.addstr(9,0,"     Z: "  + str(s.getData()[3]))
		screen.addstr(13,4, str(v.attitude))
		...
		screen.addstr(9,28,"Disarmed")
		screen.addstr(4,30,"Mode:"  )
		screen.addstr(17,0,"Press CTRL-C to exit")
		screen.addstr(18,0,"")
